...
void ParameterGridEditor::syncAuditionControls()
{
    ...
    static_cast<ehl::ui::CommandButton*> (auditionButton.get())->setSelected (voidfurnaceProcessor->isAuditionEnabled());
    static_cast<ehl::ui::CommandButton*> (auditionTypeButton.get())->setSelected (voidfurnaceProcessor->getAuditionType() != 0);
#endif
}
